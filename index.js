...
function artistInfo(artistArray, artist) {
  /*Your Code Here*/
  const copiedArray = [...artistArray];
  const artistInfo = copiedArray.find((artist) => artist.name === artist);
...
function artistByCountry(artistArray, nationality) {
  /*Your Code Here*/
  copiedArray = [...artistArray];
  const artistNationality = copiedArray.find(
    (artist) => artist.nationality === nationality
  );
  return artistNationality.name;
}
